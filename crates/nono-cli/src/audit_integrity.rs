...
pub(crate) struct SandboxRuntimeAuditEvent {
    ...
    pub(crate) tool_sandbox_active: bool,
}
...
pub(crate) struct CommandPolicyAuditEvent {
    ...
    pub(crate) env_display: Vec<CommandPolicyEnvAuditEntry>,
    pub(crate) cwd_display: String,
    pub(crate) exit_code: Option<i32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) stdio: Option<CommandPolicyStdioAudit>,
}

#[derive(Clone, Serialize, Deserialize)]
pub(crate) struct CommandPolicyEnvAuditEntry {
    pub(crate) name: String,
    pub(crate) value_display: String,
}

#[derive(Clone, Serialize, Deserialize)]
pub(crate) struct CommandPolicyStdioAudit {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) stdout: Option<CommandPolicyStdioStreamAudit>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) stderr: Option<CommandPolicyStdioStreamAudit>,
}

#[derive(Clone, Serialize, Deserialize)]
pub(crate) struct CommandPolicyStdioStreamAudit {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) on_limit: Option<String>,
}
